...
<body>
    <nav class="warna fixed top-0 z-50 w-full border-b border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    <div class="ms-3 flex flex-col-reverse items-center gap-4">
                        <!-- Settings Dropdown -->
                        <div class="hidden sm:ml-6 sm:flex sm:items-center">
                            @auth
                                <x-dropdown align="right" width="48">
                                    <x-slot name="trigger">
                                        <button class="flex items-center text-sm font-medium text-gray-500 transition duration-150 ease-in-out hover:border-gray-300 hover:text-gray-700 focus:border-gray-300 focus:text-gray-700 focus:outline-none">
                            ...
                            @else
                                <a href="{{ route('auth.login') }}" class="text-sm text-gray-700 underline dark:text-gray-500">Log in</a>
                            @endauth
                        </div>
    ...
    <aside id="logo-sidebar" class="fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full border-r border-gray-200 bg-white pt-20 transition-transform dark:border-gray-700 dark:bg-gray-800 sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full overflow-y-auto bg-white px-3 pb-4 dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('classroom.index') }}" :class="{ 'active': request() - > routeIs('classroom.index') }" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                        ...
                        <span class="ms-3 flex-1 whitespace-nowrap"> Classroom </span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('schedule.index') }}" :class="{ 'active': request() - > routeIs('schedule.index') }" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                        <svg class="h-5 w-5 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                            <path
                                d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857 8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 0 0 18 16.143v-4.286A1.857 1.857 0 0 0 16.143 10Z" />
                        </svg>
                        <span class="ms-3 flex-1 whitespace-nowrap"> Schedule </span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('absent.index') }}" :class="{ 'active': request() - > routeIs('absent.index') }" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                        ...
                        <span class="ms-3 flex-1 whitespace-nowrap">Absensi</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="group flex items-center rounded-lg p-2 text-red-900 hover:bg-red-100 dark:text-white dark:hover:bg-red-700">
                        <svg class="h-5 w-5 flex-shrink-0 text-red-500 transition duration-75 group-hover:text-red-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
    ...
    <div class="p-4 sm:ml-64">
        <main class="container-fluid bg-blue-300s">
            <div class="z-100 container mt-16">
                {{ $slot }}
            </div>
