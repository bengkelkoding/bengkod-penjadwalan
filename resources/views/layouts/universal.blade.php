            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('setting.index') }}"
                        class="{{ (Route::is('setting.index'))? 'bg-indigo-900' : '' }} flex items-center p-3 m-4 rounded-lg hover:bg-indigo-900 group">
                        <svg class="{{ (Route::is('setting.index'))? 'text-white' : '' }} flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-white"
                        aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.83 5a3.001 3.001 0 0 0-5.66 0H4a1 1 0 1 0 0 2h1.17a3.001 3.001 0 0 0 5.66 0H20a1 1 0 1 0 0-2h-9.17ZM4 11h9.17a3.001 3.001 0 0 1 5.66 0H20a1 1 0 1 1 0 2h-1.17a3.001 3.001 0 0 1-5.66 0H4a1 1 0 1 1 0-2Zm1.17 6H4a1 1 0 1 0 0 2h1.17a3.001 3.001 0 0 0 5.66 0H20a1 1 0 1 0 0-2h-9.17a3.001 3.001 0 0 0-5.66 0Z"/>  
                            </svg>
                            <span class="{{ (Route::is('setting.index'))? 'text-white' : '' }} ms-3 font-semibold text-gray-500 group-hover:text-white text-lg">Pengaturan Penjadwalan</span>
                    </a>
                </li>
                {{-- <li>
                    <a href="{{ route('setting.index') }}"
