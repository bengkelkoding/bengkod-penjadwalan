...
array("y"=> 8, "name"=> "Kelas Sesuai", "color"=> "#E7823A"), // y itu jumlahnya
array("y"=> 4, "name"=> "Kelas Kurang", "color"=> "#546BC1")
);
...
<x-universal-layout :role="$role">
    <section class="box p-3 rounded-lg h-auto  grid lg:grid-cols-3 grid-cols-1 gap-3 ">
        <div class="box1 w-auto h-[70vh] md:col-span-1 md:row-span-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            {{-- box grafik --}}
            <div class="w-auto h-[70vh] bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                <div class="flex justify-between mt-3 mb-3">
                    <div class="flex justify-center items-center">
                        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Attendence Traffic</h5>
                        ...
                        <div data-popover id="chart-info" role="tooltip" class="absolute z-10 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                            <div class="p-3 space-y-2">
                                ...
                                <p>Kelas yang tidak sesuai dengan jumlah dan waktu pertemuan yang seharusnya, misalnya minggu ke-5 perkuliahan semua kelas seharusnya sudah masuk ke pertemuan 5, tapi karena ada kelas yang kosong, jadi kelas tersebut masih masuk ke pertemuan 4</p>
                            </div>
