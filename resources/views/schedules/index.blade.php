    ...
    <div class="relative m-8 p-4 overflow-x-scroll md:overflow-x-hidden shadow-md sm:rounded-lg">
        ...
        <div class="flex gap-2 mb-4">
            <button data-modal-show="tambahSchedule" data-modal-target="tambahSchedule" type="button"
                ...
                Tambah Schedule
                <svg class="w-5 h-5 ms-2.5 hidden lg:block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <table
            class="mb-4  md:table w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 shadow-md rounded-2xl">
                ...
                @foreach ($schedules as $index => $schedule)
                    <tr class="bg-white dark:bg-gray-800  hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="flex gap-2 px-6 py-4">
                            <button data-modal-target="updateSchedule{{ $schedule->id }}"
                                data-modal-show="updateSchedule{{ $schedule->id }}" type="button"
                                class=" bg-merah text-merah border border-merah hover:bg-abu-abu hover:text-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center ">
                                <svg class="w-5 h-5 text-putih dark:text-white" aria-hidden="true"
                            ...
                            <button data-modal-target="deleteSchedule{{ $schedule->id }}"
                                data-modal-show="deleteSchedule{{ $schedule->id }}" type="button"
                                class=" bg-merah text-merah border border-merah hover:bg-abu-abu hover:text-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2">
                                <svg class="w-5 h-5 text-putih dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd"
...
{{-- Modal --}}
<!-- Tambah Schedule -->
<div id="tambahSchedule" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <form class="relative bg-white rounded-lg shadow dark:bg-gray-700" action="/insertSchedule" method="POST"
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="tambahSchedule">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-4 md:grid-cols-4 gap-3">
                    ...
                    <div class="col-span-4 md:col-span-2">
                        <label for="kode_kelompok"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Kelompok</label>
                    ...
                    <div class="col-span-4 grid grid-cols-4 md:grid-cols-4 gap-3">
                        <span
                            class="col-span-4 inline-flex justify-center items-center px-2 text-sm font-medium text-black border-b rounded">
                            Jadwal 1
                        </span>
                        ...
                        <div class="col-span-6 sm:col-span-1">
                            ...
                            <div class="relative">
                                <input name="time_start" id="time_start" type="time" id="time"
                    ...
                    <div class="col-span-4 grid grid-cols-4 md:grid-cols-4 gap-3">
                        ...
                        <div class="col-span-6 sm:col-span-1">
                            <label for="time_start2"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mulai</label>
                            <div class="relative">
                                <input name="time_start2" id="time_start2" type="time" id="time"
                                    class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    min="07:00" max="21:00" />
                            </div>
                        </div>
                        <div class="col-span-6 sm:col-span-1">
                            <label for="time_end2"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Selesai</label>
                            <div class="relative">
                                <input type="time" name="time_end2" id="time_end2"
                                    class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    min="07:00" max="21:00" />
                            </div>
                        </div>
                    ...
                    <div class="col-span-4 grid grid-cols-4 md:grid-cols-4 gap-3">
                        ...
                        <div class="col-span-6 sm:col-span-1">
                            <label for="time_start3"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mulai</label>
                            <div class="relative">
                                <input name="time_start3" id="time_start3" type="time" id="time"
                                    class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    min="07:00"
                                    max="21:00" "  />
                            </div>
    ...
    <div id="updateSchedule{{ $schedule->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <form class="relative bg-white rounded-lg shadow dark:bg-gray-700"
                action="/updateSchedule/{{ $schedule->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Modal header -->
                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    ...
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                        data-modal-hide="updateSchedule{{ $schedule->id }}">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 14 14">
                    ...
                    <div class="grid grid-cols-4 md:grid-cols-4 gap-3">
                        ...
                        <div class="col-span-4 md:col-span-2">
                            <label for="kode_kelompok"
                                ...
                                Kelompok</label>
                            <input value="{{ $schedule->kode_kelompok }}" type="text" name="kode_kelompok"
                                id="kode_kelompok"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="" required="">
                        </div>
                        <div class="col-span-4 sm:col-span-1">
                            <label for="kuota"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kuota</label>
                            <input value="{{ $schedule->kuota }}" type="number" name="kuota" id="kuota"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="" required="">
                        </div>
                        <div class="col-span-3 sm:col-span-1">
                            <label for="jumlah_mahasiswa"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah
                                Mahasiswa</label>
                            <input value="{{ $schedule->jumlah_mahasiswa }}" type="number" name="jumlah_mahasiswa"
                                id="jumlah_mahasiswa"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="" required="">
                        </div>
                        ...
                        @foreach ($schedule->scheduleSessions as $session)
                            @if ($session->schedule_id == $schedule->id)
                                <div class="col-span-4 grid grid-cols-4 md:grid-cols-4 gap-3">
                                    ...
                                    <input type="hidden" id="session_id{{ $loop->index + 1 }}"
                                        name="session_id{{ $loop->index + 1 }}" value="{{ $session->id }}">
                                    <div class="col-span-5 sm:col-span-1">
                                        <label for="day{{ $loop->index + 1 }}"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Hari</label>
                                        <select id="day{{ $loop->index + 1 }}" name="day{{ $loop->index + 1 }}"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <div class="col-span-4 sm:col-span-1">
                                        <label for="name{{ $loop->index + 1 }}"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ruang</label>
                                        <select name="name{{ $loop->index + 1 }}"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <option value="">Pilih Ruang</option>
                                            <option value="{{ $session->classrooms->name ?? '' }}" selected>
                                                {{ $session->classrooms->name ?? '-' }}</option>
                                            @foreach ($ruang as $rooms)
                                                <option value="{{ $rooms }}">{{ $rooms }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-span-6 sm:col-span-1">
                                        <label for="time_start{{ $loop->index + 1 }}"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mulai</label>
                                        <div class="relative">
                                            <input value="{{ $session->time_start }}"
                                                name="time_start{{ $loop->index + 1 }}"
                                                id="time_start{{ $loop->index + 1 }}" type="time" id="time"
                                                class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                min="07:00" max="21:00" required />
                                        </div>
                                    </div>
                                    <div class="col-span-6 sm:col-span-1">
                                        <label for="time_end{{ $loop->index + 1 }}"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Selesai</label>
                                        <div class="relative">
                                            <input value="{{ $session->time_end }}" type="time"
                                                name="time_end{{ $loop->index + 1 }}"
                                                id="time_end{{ $loop->index + 1 }}"
                                                class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                min="07:00" max="21:00" required />
                                        </div>
                                    </div>
...
@foreach ($schedules as $schedule)
    <div id="deleteSchedule{{ $schedule->id }}" tabindex="-1"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow ">
                <button type="button"
                    class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                    data-modal-hide="deleteSchedule{{ $schedule->id }}">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="merah"
                        viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    </svg>
                ...
                <div class="p-4 md:p-5 text-center">
                    <svg class="mx-auto mb-4 text-merah w-12 h-12 dark:text-gray-200" aria-hidden="true"
                    ...
                    <a href="/deleteSchedule/{{ $schedule->id }}"
                        data-modal-hide="deleteSchedule{{ $schedule->id }}" type="button"
