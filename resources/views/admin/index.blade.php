...
<x-universal-layout :role="$role">
    <section class="box p-3 rounded-lg h-auto  grid lg:grid-cols-3 grid-cols-1 gap-3 ">
        <div
            class="box1 w-auto h-[70vh] md:col-span-1 md:row-span-2 bg-blue-500 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            {{-- box grafik --}}
            <div class="p-6 grafik relative">
                ...
                <p class="mt-6 font-normal text-gray-500 dark:text-gray-400">Ganti jadi </p>
            </div>
